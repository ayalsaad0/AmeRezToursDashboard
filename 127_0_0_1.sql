...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2022 at 08:53 PM
...
('amerez', 'amerez@tours.com', 'amerez');
...
(5, './images_public/toyota-fortuner.png', 'v_4'),
...
INSERT INTO `vehicles` (`id`, `title`, `places`, `avg_rating`, `suitcases`, `price`, `available`, `driver`) VALUES
('v_1', 'MERCEDES CLASS E', 3, 3, 3, 1500, 1, 1),
('v_2', '4X4 TOYOTA TX', 6, 4, 6, 1300, 1, 0),
('v_3', '4X4 TOYOTA FORTUNER', 6, 4, 6, 1400, 1, 0),
('v_4', 'MERCEDES VITO', 7, 5, 7, 1700, 1, 1),
('v_5', 'FORD CUSTOM', 8, 5, 8, 1800, 1, 1),
('v_6', 'MERCEDES SPRINTER', 17, 5, 17, 2100, 1, 1),
('v_7', 'VOLKSWAGEN CRAFTER', 18, 5, 18, 3100, 1, 1),
('v_8', 'MINI COACH BUS', 26, 5, 26, 4000, 1, 1),
('v_9', 'COACH BUS', 45, 5, 45, 5200, 1, 1);
