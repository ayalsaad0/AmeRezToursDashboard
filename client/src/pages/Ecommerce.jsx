...
const Ecommerce = () => {
  ...
  return (
    <div className="mt-24">
      ...
      >
        <div className="bg-white dark:text-gray-200 w-2/5 dark:bg-secondary-dark-bg h-44 rounded-xl p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
